...
namespace SimpleDB.Test.Core
{
    class QueryExecutorTest
    {
        ...
        private QueryExecutor<TestEntity> _queryExecutor;
        ...
        public void Setup()
        {
            ...
            _queryExecutor = new QueryExecutor<TestEntity>(_mapper, _collection.DataFile, _collection.PrimaryKeys.Values);
        }
